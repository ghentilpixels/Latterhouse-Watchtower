    ...
    <div className="pt-24 pb-20 bg-slate-50 min-h-screen">
      ...
      <section className="bg-slate-900 text-white py-20 mb-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Sermons & Messages</h1>
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Catch up on past series, listen to recent messages, and dive deeper into God's Word.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {sermons.map((sermon) => (
            <SermonCard key={`duplicate-${sermon.id}`} sermon={{...sermon, id: sermon.id + 10}} />
          ))}
        </div>
